...
function Contact() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_nm3jfan', 'template_xogdirw', formRef.current, 'NM8vhu7uv8EY9aRUt')
            .then((result) => {
                setSuccess(true);
            }, (error) => {
                setError(true);
        ...
        <motion.div className='contact' ref={ref} variants={variants} initial='initial' whileInView='animate'>
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>abhayajeet02@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Address</h2>
                    <span>Kasturi Nagar 1st line, Rayagada, Odisha</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Phone</h2>
                    <span>+91 8342836062</span>
                </motion.div>
            </motion.div>
